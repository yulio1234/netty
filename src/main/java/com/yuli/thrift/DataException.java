...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2019-02-15")
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  private static final org.apache.thrift.protocol.TField CALL_STATCK_FIELD_DESC = new org.apache.thrift.protocol.TField("callStatck", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public @org.apache.thrift.annotation.Nullable String callStatck; // optional
  public @org.apache.thrift.annotation.Nullable String date; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    MESSAGE((short)1, "message"),
    CALL_STATCK((short)2, "callStatck"),
    DATE((short)3, "date");
  ...
  private static final _Fields optionals[] = {_Fields.MESSAGE,_Fields.CALL_STATCK,_Fields.DATE};
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.MESSAGE, new org.apache.thrift.meta_data.FieldMetaData("message", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
    tmpMap.put(_Fields.CALL_STATCK, new org.apache.thrift.meta_data.FieldMetaData("callStatck", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
  ...
  public DataException(DataException other) {
    ...
    if (other.isSetCallStatck()) {
      this.callStatck = other.callStatck;
    }
    if (other.isSetDate()) {
  ...
  public String getCallStatck() {
    return this.callStatck;
  }

  public DataException setCallStatck(@org.apache.thrift.annotation.Nullable String callStatck) {
    this.callStatck = callStatck;
    return this;
  }

  public void unsetCallStatck() {
    this.callStatck = null;
  }

  /** Returns true if field callStatck is set (has been assigned a value) and false otherwise */
  public boolean isSetCallStatck() {
    return this.callStatck != null;
  }

  public void setCallStatckIsSet(boolean value) {
    if (!value) {
      this.callStatck = null;
    }
  }
  ...
  public boolean equals(DataException that) {
    ...
    boolean this_present_callStatck = true && this.isSetCallStatck();
    boolean that_present_callStatck = true && that.isSetCallStatck();
    if (this_present_callStatck || that_present_callStatck) {
      if (!(this_present_callStatck && that_present_callStatck))
        return false;
      if (!this.callStatck.equals(that.callStatck))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCallStatck()) ? 131071 : 524287);
    if (isSetCallStatck())
      hashCode = hashCode * 8191 + callStatck.hashCode();
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = Boolean.valueOf(isSetCallStatck()).compareTo(other.isSetCallStatck());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallStatck()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callStatck, other.callStatck);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetCallStatck()) {
      if (!first) sb.append(", ");
      sb.append("callStatck:");
      if (this.callStatck == null) {
        sb.append("null");
      } else {
        sb.append(this.callStatck);
      }
      first = false;
    }
    if (isSetDate()) {
  ...
  private static class DataExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<DataException> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DataException struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // CALL_STATCK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.callStatck = iprot.readString();
              struct.setCallStatckIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataException struct) throws org.apache.thrift.TException {
      ...
      if (struct.callStatck != null) {
        if (struct.isSetCallStatck()) {
          oprot.writeFieldBegin(CALL_STATCK_FIELD_DESC);
          oprot.writeString(struct.callStatck);
          oprot.writeFieldEnd();
        }
      }
      if (struct.date != null) {
